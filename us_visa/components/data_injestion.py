...
class DataInjestion:
    def __init__(self,data_injestion_config:DataInjestionConfig=DataInjestionConfig()):
        """
    ...
    def export_data_into_feature_store(self)->DataFrame:
        ...
        try:
            ...
            dataframe = usvisa_data.export_collection_as_dataframe(collection_name=
                                                                   self.data_injestion_config.collection_name)
    ...
    def split_data_as_train_test(self,dataframe: DataFrame) ->None:
        ...
        try:
            train_set, test_set = train_test_split(dataframe, test_size=self.data_injestion_config.train_test_split_ratio)
    ...
    def initiate_data_injestion(self) ->DataInjestionArtifact:
        ...
        try:
            ...
            data_injestion_artifact = DataInjestionArtifact(trained_file_path=self.data_injestion_config.training_file_path,
